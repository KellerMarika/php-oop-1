...
$movie1 = new Movie("l'incredibile Hulk(cartone)", "Hulk spacca", $genres_List1,$actors_List1,"",$vote_List1);
var_dump($movie1);
...
$movie2 = new Movie("John Wick", "il cane no!", $genres_List2,$actors_List2,"",$vote_List2);
var_dump($movie2);
...
$movie3 = new Movie("titanic", "Nave inaffondabile affonda", $genres_List3,$actors_List3,"IT");
var_dump($movie3);
